...
namespace SOSTeam.TravelAgency.WPF.ViewModels.Guest2
{
    public class TourViewModel2
    {
        ...
        public TourViewModel2(int id,string name,string language,int duration,int maxNumOfGuests,string city,string country,User loggedInUser,ToursOverviewWindow window) 
        {
            _window = window;
            TourId = id;
            Name = name;
